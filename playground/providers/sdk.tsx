...
import { ArkSDK, CHAINS } from '@a42n-olympus/ark-dao-sdk';
import { defaultChain, supportedChains } from 'env-dynamics.mjs';
...
export const ArkSDKProvider: React.FC<PropsWithChildren> = ({ children }) => {
  ...
  const value = useMemo(() => {
    const sdk = new ArkSDK({
      chainId:
        chainId && supportedChains.includes(chainId) ? chainId : defaultChain,
