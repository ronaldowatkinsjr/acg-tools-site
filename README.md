...
4. In the root directory of the repository, execute the below command to start the vercel deployment. Update the env variable according to `.env` before executing the command
...
5. Once the build is done, the site should be available at the deployed domain.
